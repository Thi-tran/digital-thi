...
#   gcloud secrets create database-url --replication-policy=automatic --project=digital-tarmo-497317
#   echo -n "postgresql+asyncpg://USER:PASSWORD@PRIVATE_IP:5432/DB" | \
#     gcloud secrets versions add database-url --data-file=- --project=digital-tarmo-497317
